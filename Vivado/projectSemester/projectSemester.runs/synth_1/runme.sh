...
HD_PWD='C:/git/digital-circuits-desighs-workspace/Vivado/projectSemester/projectSemester.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SIPO_shift_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SIPO_shift_reg.tcl
